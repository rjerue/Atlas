...
public class PinLocationProvider implements
    ...
    public abstract interface PinCallback {
    ...
    private PinCallback mLocationCallback;
    private Bitmap bitmap;
    private Context mContext;
    private GoogleApiClient mGoogleApiClient;
    private LocationRequest mLocationRequest;

    public PinLocationProvider(Context context, PinCallback callback, Bitmap bitmap) {
    ...
    public void onConnected(Bundle bundle) {
        ...
        if (location == null) {
            ...
            mLocationCallback.handleNewPin(location, bitmap);
        }
    }
